...
function extractVideoID(url) {
  var match = url.match(/(?:\/|%3D|v=|vi=)([0-9A-Za-z_-]{11})(?:[^\w-]|$)/);
...
const getSingleUserAllData = async (req, res) => {
  try {
    ...
    await User.findOne({ '_id': studentID }, { Username: 1, Email: 1, gov: 1, Markez: 1, gender: 1, phone: 1, WhatsApp: 1, parentPhone: 1, place: 1, Code: 1, createdAt: 1, updatedAt: 1, subscribe: 1 , PasswordWithOutHash : 1})
      .then((result) => {
